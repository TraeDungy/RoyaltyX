...
- **support** – ticketing system with AI help chat and FAQ
...
A detailed listing of Django apps is available in [documentation/BACKEND_APPS.md](documentation/BACKEND_APPS.md).
