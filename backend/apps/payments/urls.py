...
urlpatterns = [
    ...
    path("payment-methods/", views.payment_methods, name="payments.payment_methods"),
    path("payment-methods/add/", views.add_payment_method, name="payments.add_payment_method"),
    path("payment-methods/remove/", views.remove_payment_method, name="payments.remove_payment_method"),
    path("payment-methods/default/", views.set_default_payment_method, name="payments.set_default_payment_method"),
]
