...
@shared_task
def task_fetch_square_sales():
    print("Running task for fetching Square sales.", flush=True)
    fetch_square_sales()


@shared_task
def task_fetch_square_stats():
    print("Running task for fetching Square stats.", flush=True)
    fetch_square_stats()
