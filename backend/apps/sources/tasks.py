...
@shared_task
def task_fetch_shopify_orders():
    print("Running task for fetching Shopify orders.", flush=True)
    fetch_shopify_orders()


@shared_task
def task_fetch_shopify_stats():
    print("Running task for fetching Shopify stats.", flush=True)
    fetch_shopify_stats()
