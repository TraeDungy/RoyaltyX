    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='report-templates/')),
        ...
        migrations.AddField(
            model_name='report',
            name='template',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='report.reporttemplates'),
