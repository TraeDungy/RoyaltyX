...
class Email:
    ...
    def send(
        ...
        try:
            ...
            logger.info(f"Simple email sent successfully to {len(recipient_list)} recipients")
            return True
    ...
    def send_html_email(
        ...
        try:
            ...
            logger.info(f"HTML email sent successfully to {len(recipient_list)} recipients")
            return True
    ...
    def send_template_email(
        ...
        try:
            ...
            logger.info(f"Template email sent successfully to {len(recipient_list)} recipients")
            return True
