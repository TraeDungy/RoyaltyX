            ...
            {isOpen && (
                ...
                >
                    ...
                    <div className='list-group'>
                        ...
                        >
                            <div className='d-flex justify-content-between align-items-center'>
                                ...
                                <div>
                                    <Envelope className='me-1 pointer txt-lighter' /> <Trash className='me-1 pointer txt-lighter' /> <EnvelopeOpen className='me-1 pointer txt-lighter' />
                                </div>
                            </div>
                            <span className='small txt-lighter'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fugiat, numquam quam.</span>
                        </button>
                        <button
                            className='list-group-item list-group-item-action'
                        >
                    ...
                    <div className='d-flex justify-content-between pb-2 pt-1'>
                        <span className='px-3 pointer medium txt-primary d-flex align-items-center'><EnvelopeOpen className='me-1' /> Inbox</span>
                        <span className='px-3 pointer medium txt-primary'>Mark all as read</span>
                    </div>
                </div>
            )}
        </div>
