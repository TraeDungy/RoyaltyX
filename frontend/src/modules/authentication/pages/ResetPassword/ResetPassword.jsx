            ...
            <div style={{ maxWidth: 470 }} className='w-100'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='py-2'>
                        ...
                        <input type="password" name='current_password' className='form-control py-3' placeholder='••••••••' />
                    </div>
                    <div className='py-2'>
                        <label className='mb-1'>New Password <span className='text-danger'>*</span></label>
                        <input type="password" name='new_password' className='form-control py-3' placeholder='••••••••' />
                    </div>
                    <div className='py-2'>
                        <label className='mb-1'>New Password <span className='text-danger'>*</span></label>
                        <input type="password" name='confirm_password' className='form-control py-3' placeholder='••••••••' />
                    </div>
