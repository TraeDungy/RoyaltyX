...
export const SourceAnalytics = ({ analytics }) => {
  ...
  if (!analytics?.source_analytics || analytics.source_analytics.length === 0) {
    return (
                ...
                <TableRow key={source.id} hover>
                  ...
                  <TableCell align="right">
                    <Typography variant="body2" color="success.main">
                      {formatCurrency(source.analytics.total_impression_revenue)}
                    </Typography>
                  </TableCell>
                  <TableCell align="right">
                    <Box>
                  ...
                  <TableCell align="right">
                    <Typography variant="body2" color="success.main">
                      {formatCurrency(source.analytics.total_royalty_revenue)}
                    </Typography>
                  </TableCell>
                  <TableCell align="right">
