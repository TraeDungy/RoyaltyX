        ...
        <div className="container px-5">
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <h4 class="mb-4">Select Date Range</h4>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="startDate" class="form-label">Start Date</label>
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="startDate" placeholder="Select start date" aria-label="Start Date" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control datepicker" id="endDate" placeholder="Select end date" aria-label="End Date" />
                                    <span class="input-group-text"><i class="bi bi-calendar"></i></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <button class="btn btn-outline-primary" type="button" id="last7Days">Last 7 Days</button>
                            <button class="btn btn-outline-primary" type="button" id="thisMonth">This Month</button>
                            <button class="btn btn-outline-primary" type="button" id="lastMonth">Last Month</button>
                            <button class="btn btn-outline-primary" type="button" id="last30Days">Last 30 Days</button>
                        </div>
                    </div>
                    <div class="mt-4 pt-3 border-top">
                        <button class="btn btn-primary px-4" type="button" id="applyRange">Apply Range</button>
                        <button class="btn btn-light ms-2" type="button" id="clearRange">Clear</button>
                    </div>
                </div>
            </div>
