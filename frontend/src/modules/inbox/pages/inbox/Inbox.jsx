                            ...
                            <div class="chat-user-panel px-3">
                                <div class="d-flex flex-column navigation-mobile pagination-scrool chat-user-scroll">
                                    ...
                                    <div class="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                                        ...
                                        <div class="flex-shrink-0 margin-auto pl-2 pr-3">
                                            <div class="d-flex flex-column">
                                                <p class="text-lighter text-right fs-13 mb-2">yesterday</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                                        ...
                                        <div class="flex-shrink-0 margin-auto pl-2 pr-3">
                                            <div class="d-flex flex-column">
                                                <p class="text-lighter text-right fs-13 mb-2">4.10.2021</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                                        ...
                                        <div class="flex-shrink-0 margin-auto pl-2 pr-3">
                                            <div class="d-flex flex-column">
                                                <p class="text-lighter text-right fs-13 mb-2">6.10.2021</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="chat-item d-flex pl-3 pr-0 pt-3 pb-3">
                                        ...
                                        <div class="flex-shrink-0 margin-auto pl-2 pr-3">
                                            <div class="d-flex flex-column">
                                                <p class="text-lighter text-right fs-13 mb-2">1.9.2021</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-100 p-3">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        ...
                                        <div class="message-options">
                                            ...
                                            <div class="message-arrow"><i class="text-lighter la la-angle-down fs-17"></i></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">Oh hey, I didn’t see you there. Did you already get a table?</p>
                                        <div class="message-options">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">I’m glad we had time to meet up.</p>
                                        <div class="message-options">
                                    ...
                                    <div class="d-flex flex-row-reverse mb-2">
                                        <div class="right-chat-message fs-13 mb-2">
                                            <div class="d-flex flex-row">
                                                <div class="me-5">Not much. Hey, how did your interview go? Wasn’t that today?</div>
                                                <div class="pr-4"></div>
                                            </div>
                                            <div class="message-options dark">
                                                <div class="message-time">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">Oh, yeah. I think it went well. I don’t know if I got the job yet, but they said they would call in a few days.</p>
                                        <div class="message-options">
                                    ...
                                    <div class="d-flex flex-row-reverse mb-2">
                                        <div class="right-chat-message fs-13 mb-2">
                                            <div class="mb-0 mr-3 pe-5">
                                                <div class="d-flex flex-row">
                                                    <div class="me-5">Well, I’m sure you did great. Good luck.</div>
                                                    <div class="pr-4"></div>
                                                </div>
                                            </div>
                                            <div class="message-options dark">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">Thanks. I’m just happy that it’s over. I was really nervous about it.</p>
                                        <div class="message-options">
                                    ...
                                    <div class="d-flex flex-row-reverse mb-2">
                                        <div class="right-chat-message fs-13 mb-2">
                                            <div class="d-flex flex-row">
                                                <div class="me-5">I can understand that. I get nervous before interviews, too</div>
                                                <div class="pr-4"></div>
                                            </div>
                                            <div class="message-options dark">
                                                <div class="message-time">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">Well, thanks for being supportive. I appreciate it.</p>
                                        <div class="message-options">
                                    ...
                                    <div class="left-chat-message fs-13 mb-2">
                                        <p class="mb-0 mr-3 pe-5">Hey Quan, If you are free now we can meet tonight ?</p>
                                        <div class="message-options">
